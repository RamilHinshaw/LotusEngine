...
void Graphics::DrawSprite(float xPos, float yPos, float width, float height)
{
    ...
    Vertex vertices[] = {
            ...
            Vertex(glm::vec3((0.0f + xPos) ,  (-1.0f - yPos ) - height, 0),	glm::vec4(1.0f, 1.0f, 1.0f, 1.0f), 	glm::vec2(1.0f, 1.0f), 	0.0f),      //Bot Left
            Vertex(glm::vec3( (1.0f + xPos) + width,  (-1.0f - yPos ) - height, 0),	glm::vec4(1.0f,	1.0f, 1.0f, 1.0f), 	glm::vec2(1.0f, 0.0f), 	0.0f),      //Bot Right
            Vertex(glm::vec3( (1.0f + xPos) + width,  (0.0f - yPos)  , 0),	glm::vec4(1.0f, 1.0f, 1.0f, 1.0f), 	glm::vec2(0.0f, 0.0f), 	0.0f),      //Top Right
