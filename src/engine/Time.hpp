...
class Time
{
    ...
    private:
        ...
        // static int m_fps;           //
        static int m_targetFPS;     //fps engine will try to reach
        ...
        static float m_currentTime; //used for delta time
        static float m_lastTime;    //used for delta time
        static unsigned long m_counterStart; //used to subtract initial startup time for more accurate delta time